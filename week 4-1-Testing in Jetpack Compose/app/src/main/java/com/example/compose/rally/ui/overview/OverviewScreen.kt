...
private fun AlertCard() {
    ...
    val infiniteElevationAnim = rememberInfiniteTransition()
    // reverse 모드를 사용해 finishedListener 를 대체
    val animationElevation: Dp by infiniteElevationAnim.animateValue(
        initialValue = 1.dp,
        targetValue = 8.dp,
